...
#ifndef __FILE_FORMATTER_HH
#define __FILE_FORMATTER_HH
#include "CHandler.h"
class FileFormatter:public CFormatter
{
public:
	FileFormatter()
	{
...
private:
	FileFormatter(const FileFormatter&);
	FileFormatter& operator=(const FileFormatter&);
};
#endif
